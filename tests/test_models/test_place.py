...
class TestPlace(unittest.TestCase):
    ...
    def document_constract_test(self):
        document = Place.__init__.__doc__
    ...
    def pep8_test(self):
        styles = pep8.StyleGuide(quiet=True).check_files(['models/place.py'])
    ...
    def pep8_place_test(self):
        styles = pep8.StyleGuide(quiet=True).check_files(['tests/test_models/test_place.py'])
        self.assertEqual(styles.total_errors, 0,"error or warning found.")
